...
from llm.client import LLMVendor, VendorSettings
...
class SettingsPage(QWidget):
    ...
    def _build(self):
        ...
        self._vendor_seg.valueChanged.connect(
            lambda v: self._on_vendor_changed(int(v))
        )
        card.add(self._vendor_seg)
    ...
    def _load(self):
        ...
        self._vendor_index = get_active_vendor()
        self._vendor_seg.setValue(str(self._vendor_index))
        self._apply_vendor_state(self._vendor_index)
    ...
    def _save_current_vendor_state(self):
        self._vendor_state[self._vendor_index] = {
    ...
    def _on_test(self):
        ...
        settings = VendorSettings(
            LLMVendor.ANTHROPIC if preset.get("proto") == "anthropic" else LLMVendor.OPENAI,
