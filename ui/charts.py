"""QPainter 图表组件 — 指标演化折线图、六维评估雷达图与演化过程泳道图。
...
from core.constants import ACTION_LABELS_SHORT as ACTION_LABELS
...
# 行动标签 ACTION_LABELS 由 core.constants.ACTION_LABELS_SHORT 提供（见文件顶部 import）
ACTION_COLORS = {
